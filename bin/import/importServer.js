...
var importApp;
function startImportServer(portNumber) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            importApp.listen(portNumber, function () {
                return console.log("Example app listening on port " + portNumber + "!");
            });
            importApp.post("/", function (req, res) {
